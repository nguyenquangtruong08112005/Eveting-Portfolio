...
export function ArtistStars({ onSelectArtist }: ArtistStarsProps) {
  ...
  if (loading) {
    return (
      <section className="max-w-7xl mx-auto px-6 py-10 w-full relative overflow-hidden rounded-3xl bg-gradient-to-b from-[var(--surface)]/40 to-transparent border border-[var(--surface-border)] mb-6">
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-10 w-full relative overflow-hidden rounded-3xl bg-gradient-to-b from-[var(--surface)]/40 to-transparent border border-[var(--surface-border)] mb-6">
      ...
      <div className="flex justify-between items-center mb-6 relative z-10 px-4">
        ...
        <span className="text-xs font-bold text-[var(--text-muted)] hover:text-[var(--primary)] transition-colors cursor-pointer flex items-center gap-0.5">
        ...
        {profiles.map((profile) => {
          ...
          return (
            <div
              ...
              className="flex-shrink-0 text-center group cursor-pointer bg-[var(--surface)]/40 hover:bg-[var(--surface)]/90 border border-[var(--surface-border)] hover:border-[var(--primary)]/30 rounded-2xl p-4 transition-all duration-300 w-32 relative flex flex-col items-center shadow-lg"
            >
