...
const verifyEventOwnership = async (req, res, next) => {
    try {
        // Lấy eventId từ params, body, hoặc query
...
const registerOrganizer = async (req, res) => {
    try {
        ...
        console.error("Error in registerOrganizer:", error); // Log lỗi thật
        res.status(500).send({ error: 'Internal Server Error' }); // Trả lỗi chung
    }
};
...
const getOrganizerProfile = async (req, res) => {
    try {
        ...
        console.error("Error in getOrganizerProfile:", error); // Log lỗi thật
        res.status(500).send({ error: 'Internal Server Error' }); // Trả lỗi chung
    }
};
...
const getMyEvents = async (req, res) => {
    try {
        ...
        console.error("Error in getMyEvents:", error); // Log lỗi thật
        res.status(500).send({ error: 'Internal Server Error' }); // Trả lỗi chung
    }
};
...
const getStatsOverview = async (req, res) => {
    try {
        ...
        console.error("Error in getStatsOverview:", error); // Log lỗi thật
        res.status(500).send({ error: 'Internal Server Error' }); // Trả lỗi chung
    }
};
...
const getEventStats = async (req, res) => {
    try {
        ...
        console.error("Error in getEventStats:", error); // Log lỗi thật
        res.status(500).send({ error: 'Internal Server Error' }); // Trả lỗi chung
    }
};
