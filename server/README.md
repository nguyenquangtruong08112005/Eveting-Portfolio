...
- **Thông báo:** Gửi thông báo đẩy (push notifications) qua Firebase Cloud Messaging.
...
- **Dịch vụ Cloud:** Firebase (Authentication, Cloud Functions, Cloud Messaging)
...
```
/
├── config/         # Cấu hình cho các dịch vụ (DB, Firebase, ZaloPay)
...
3.  **Cấu hình môi trường:**
    Tạo một file `.env` ở thư mục gốc và định nghĩa các biến môi trường cần thiết. Bạn có thể tham khảo các file trong thư mục `config/` để biết các biến cần thiết (ví dụ: thông tin kết nối Firebase, Elasticsearch, khóa bí mật cho JWT).
